...
conn = sqlite3.connect("C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Google Chrome.lnk") #connect to the google chrome history database "add your path"
cursor = conn.cursor()
